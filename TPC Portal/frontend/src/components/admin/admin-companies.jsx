...
*/
  ButtonClick = () =>{
    ...
    const selectedDataStringPresentation = selectedData.map(node => node.company + ' ' + node.job).join(', ');
    alert(`Selected Nodes: ${selectedDataStringPresentation}`)
  }
  render()
  {
    return(
      <div className="container border rounded p-3 m-2 border-success">
      <div
      ...
      <div className="container-fluid row mt-2">
        <div className="col-md-3">
          <button type="button" className="btn btn-block btn-success m-1">Add Company</button>
        </div>
        <div className="col-md-3">
          <button type="button" className="btn btn-block btn-success m-1">Delete Company</button>
        </div>
        <div className="col-md-3">
          <button type="button" className="btn btn-block btn-success m-1">Deactivate</button>
        </div>
        <div className="col-md-3">
          <button type="button" className="btn btn-block btn-success m-1" onClick={this.ButtonClick}>Add Bulk Company</button>
        </div>
      </div>
    </div>
    );
