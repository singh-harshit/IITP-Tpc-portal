...
export class AdminJobMarkProgress extends React.Component
{
  ...
  this.state = {
    ...
    getAllDetails = () =>{
      ...
      getProgress = () =>{
        axios.get(`/backend/admin/jobs/markProgress/${this.state.id}`,{
          headers: {
            'x-auth-token': this.state.authToken,
            'x-refresh-token': this.state.refreshToken,
          }
      ...
      handleMarkCompleted = (event) =>{
        ...
        axios({
          url: `/backend/admin/jobs/markCompleted/${this.state.id}`,
          method: 'patch',
          data: payload,
          headers: {
            'x-auth-token': this.state.authToken,
  ...
  handleSubmit = (event) =>{
    ...
    axios({
      url: `/backend/admin/jobs/addStep/${this.state.id}`,
      method: 'patch',
      data: payload,
      headers: {
        'x-auth-token': this.state.authToken,
  ...
  handleSaveProgress = (event)=>{
    ...
    axios({
      url: `/backend/admin/jobs/saveProgress/${this.state.id}`,
      method: 'patch',
      data: payload,
      headers: {
        'x-auth-token': this.state.authToken,
  ...
  handleSaveStatus = ()=>{
    ...
    axios({
      url: `/backend/admin/jobs/saveJobStatus/${this.state.id}`,
      method: 'patch',
      data: payload,
      headers: {
        'x-auth-token': this.state.authToken,
  ...
  handleDeleteSubmit = (event)=>{
    ...
    axios({
      url: `/backend/admin/jobs/removeStep/${this.state.id}`,
      method: 'patch',
      data: payload,
      headers: {
        'x-auth-token': this.state.authToken,
